@extends('base')
    @section('content')
        <div class="col-12">
            <form action="/semester/insert" method="post" class="card" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                    <div class="row">
                                ...
                                <fieldset class="form-fieldset">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control rtl" name="type">
                                            <option value="SPRING">نیم سال اول</option>
                                            <option value="WINTER">نیم سال دوم</option>
